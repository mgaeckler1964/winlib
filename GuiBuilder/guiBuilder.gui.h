...
namespace winlibGUI {
	...
	const int attachment_id=236;
	const int attachmentLabel_id=235;
	const int BackgroundColor_id=248;
	const int BackgroundColorLabel_id=247;
	const int baseClass_id=254;
	const int baseClassLabel_id=253;
	const int BottomFrame_id=203;
	const int BUTTON_id=173;
	const int BUTTO_BAR_id=172;
	const int CHARTCHILD_id=197;
	const int CHECKBOX_id=183;
	const int childCaption_id=206;
	const int childHeight_id=214;
	const int childHeightLabel_id=213;
	const int childWidth_id=212;
	const int childWidthLabel_id=211;
	const int COMBOBOX_id=175;
	const int controlName_id=205;
	const int controlStyle_id=252;
	const int controlStyleLabel_id=251;
	const int DATETIMEPICKER_id=196;
	const int downBUTTON_id=264;
	const int downLABEL_id=263;
	const int EDIT_id=176;
	...
	const int FRAMECHILD_id=179;
	const int GakIcon_id=158;
	const int GRIDVIEWER_id=199;
	const int growHEIGHT_id=226;
	const int growHEIGHTLabel_id=225;
	const int growWIDTH_id=224;
	const int growWIDTHLabel_id=223;
	const int GuiDefinitions_id=272;
	const int GuiIcon_id=159;
	const int HELLO_WORLD1_id=266;
	const int HELLO_WORLD2_id=267;
	const int HELLO_WORLD3_id=268;
	const int H_SCROLLBAR_id=187;
	const int H_TRACKBAR_id=180;
	const int itemList_id=256;
	const int itemListLabel_id=255;
	const int LABEL1_id=265;
	const int layoutHEIGHT_id=222;
	const int layoutHEIGHTLabel_id=221;
	const int layoutManager_id=238;
	const int layoutManagerLabel_id=237;
	const int layoutWIDTH_id=220;
	const int layoutWIDTHLabel_id=219;
	const int layout_xPOS_id=216;
	const int layout_xPOSLabel_id=215;
	const int layout_yPOS_id=218;
	const int layout_yPOSLabel_id=217;
	const int LISTBOX_id=174;
	const int MAIN_MENU_id=155;
	const int marginBOTTOM_id=246;
	const int marginBOTTOMLabel_id=245;
	const int marginLEFT_id=240;
	const int marginLEFTLabel_id=239;
	const int marginRIGHT_id=242;
	const int marginRIGHTLabel_id=241;
	const int marginTOP_id=244;
	const int marginTOPLabel_id=243;
	const int MEMOCONTROL_id=185;
	const int MenuTestModalPopup_id=152;
	const int MenuTestPopup_id=153;
	const int MENU_FILE_id=148;
	const int MENU_INFO_id=154;
	const int numCols_id=258;
	const int numColsLABEL_id=257;
	const int numRows_id=260;
	const int numRowsLABEL_id=259;
	const int OPEN_GUI_FILE_id=270;
	const int paddingBOTTOM_id=234;
	const int paddingBOTTOMLabel_id=233;
	const int paddingLEFT_id=228;
	const int paddingLEFTLabel_id=227;
	const int paddingRIGHT_id=230;
	const int paddingRIGHTLabel_id=229;
	const int paddingTOP_id=232;
	const int paddingTOPLabel_id=231;
	const int Properties_id=136;
	const int PUSHBUTTON_id=182;
	const int PUSHBUTTON1_id=160;
	const int PUSHBUTTON2_id=162;
	const int PUSHBUTTON3_id=161;
	const int PUSHBUTTON4_id=163;
	const int PUSHBUTTON5_id=164;
	const int PUSHBUTTONx1_id=166;
	const int PUSHBUTTONx2_id=167;
	const int PUSHBUTTONx3_id=168;
	const int PUSHBUTTONx4_id=169;
	const int PUSHBUTTONx5_id=170;
	const int PUSHBUTTONx6_id=171;
	const int PUSHBUTTON_Bottom_id=190;
	const int PUSHBUTTON_Full_id=194;
	const int PUSHBUTTON_Left_id=193;
	const int PUSHBUTTON_Right_id=192;
	const int PUSHBUTTON_Top_id=191;
	const int RADIOBUTTON_id=184;
	const int SAVE_GUI_FILE_id=271;
	const int SelectFontButton_id=250;
	const int SelectFontCheck_id=249;
	const int StringListEditor_id=134;
	const int stringListGrid_id=200;
	const int StyleDialog_id=130;
	const int StyleListBox_id=189;
	const int SysType_id=157;
	const int TABCONTROL_id=195;
	const int TabFrame1_id=137;
	const int targetLanguageCombo_id=201;
	const int TestLabel_id=177;
	const int TestModalPoup_id=129;
	const int TestPopup_id=132;
	const int TEST_ATTACHMENT_id=131;
	const int TEST_MENU_id=156;
	const int TEST_STRING_id=269;
	const int TEST_xmlGridFORM_id=133;
	const int TOOL_BAR_id=165;
	const int TopFrame_id=202;
	const int TranslationForm_id=135;
	const int translationsGrid_id=204;
	const int TREEVIEW_id=181;
	const int upBUTTON_id=262;
	const int UPDOWNBUTTON_id=178;
	const int upLABEL_id=261;
	const int VIEW_ITEM_LIST_id=150;
	const int VIEW_ITEM_TREE_id=151;
	const int V_SCROLLBAR_id=188;
	const int V_TRACKBAR_id=186;
	const int XMLEDITORCHILD_id=198;
	const int xPOS_id=208;
	const int xPOSLabel_id=207;
	const int yPOS_id=210;
	const int yPOSLabel_id=209;
